    ...
    def update(self):
        ...
        if self.is_alive:
            ...
            if self.phase == 3:
                ...
                if pyxel.btnr(pyxel.MOUSE_BUTTON_LEFT) or self.temp_val >= self.temp_max:
        ...
        if pyxel.btnp(pyxel.KEY_P) or pyxel.btnp(pyxel.MOUSE_BUTTON_RIGHT):
            if self.is_alive: 
        ...
        if not self.is_alive:
            ...
            if pyxel.btnp(pyxel.KEY_R): self.reset_game_full()
    ...
    def draw(self):
        ...
        if self.is_alive:
            ...
            if self.phase == 3:
                ...
                pyxel.text(self.SCREEN_W - 60, 10, "HOLD CLICK!", 7 if pyxel.frame_count % 10 < 5 else 8)
            ...
            # デバッグ用（消してもOK）
            # pyxel.text(5, 35, f"ESTROUS:{self.estrous}", 5)
            ...
            # リザルト
            pyxel.text(self.SCREEN_W//2 - 40, self.SCREEN_H//2 + 35, "Hold 'L' for Collection", 7)
